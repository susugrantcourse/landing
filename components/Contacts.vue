<template>
  <section class="bg-white border-b py-8" id="contacts">
    <div class="container max-w-6xl mx-auto">
      <br />
      <br />
      <h1 class="w-full text-4xl leading-tight text-center text-gray-900">
        Контакты
      </h1>
      ...
      <div class="flex flex-wrap flex-col sm:flex-row md:mb-2">
        <div
          class="w-full md:w-7/12 lg:w-7/12 px-6 sm:p-6 mt-2 md:mt-6 text-center"
        >
          <iframe
    ...
    <br />
    <br />
    <!-- <hr class="border-b border-gray-500 opacity-25 my-0 py-0" /> -->
  </section>
</template>
